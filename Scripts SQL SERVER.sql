...
FROM ALUNO
GO
/* trazendo data no formato br jeito errado*/
SELECT NOME,
...
/* CORRECAO jeito certo de trazer  a data em formato br*/
...
CONTAGEM DEFAULT sem parametro
 - INICIA EM 01
*/
...
/* MELHOR FORMA DE SE FAZER UMA TRIGGLER, DE UM JEITO MAIS SIMPLIFICADO COM MENOS CÓDIGOS, MAS COM O MESMO RESULTADO, JEITO RECOMENDADO*/
...
/* PROCEDURES */
-- NO SQLSERVER NÃO EXISTI OS COMANDO SHOW TABLE SHOW DATABASE IGUAL TEM NO MYSQL , PARA ACESSAR ESSAS INFORMAÇÕES USAMOS O SP_STORAGE PROCEDURE*/
--SP_ STORAGE PROCEDURE
-- CHECK  E COMO SE FOSSE O COMANDO ENUM DO MYSQL
CREATE TABLE PESSOA(
...
/* T-SQL TRANSACTION SQL -> LINGUAGEM QUE O SQL SERVER TRABALHA */
...
BEGIN
		...
		--E UM SO RESULTADO
		--Vai Retorna apenas apenas uma coluna e resultado
		-- E vai atribuir o resultado na variavel com o set
		...
		--METODO 2
		--Colocando a variavel no meio da query
...
/*fUNÇÃO  CASE, CASE NÃO E PROGRAMAÇÃO, POSSO USAR NO SELECT -- CASE REPRESENTA UMA COLUNA
MAS PODE SER USADO DENTRO E FORA DA PROGRAMAÇÃO */
